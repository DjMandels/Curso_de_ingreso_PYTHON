...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        val_1 = self.txt_importe.get()
        val_2 = self.txt_descuento.get()
        aux = float(val_1) * float(val_2) / 100
        result = float(val_1) - aux
        alert("Restultado","El importe con descuento es: " + str((result)))
